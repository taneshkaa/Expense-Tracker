...
def edit_expense():
	...
	edit_btn = Button(data_entry_frame, text='Edit expense', font=btn_font, width=25,
...
dataentery_frame_bg = 'IndianRed'
buttons_frame_bg = 'Pink'
...
date = DateEntry(data_entry_frame, date=datetime.datetime.now(), font=entry_font)
...
Button(data_entry_frame, text='Convert to words before adding', font=btn_font, width=25, bg=hlb_btn_bg).place(x=10,y=450)
...
Button(buttons_frame, text='Delete All Expenses', font=btn_font, width=24, bg=hlb_btn_bg, command=remove_all_expenses).place(x=640, y=5)
...
Button(buttons_frame, text='Convert Expense to a sentence', font=btn_font, width=24, bg=hlb_btn_bg,
